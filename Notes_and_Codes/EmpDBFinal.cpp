...
public:
    ...
    virtual void retrieveData(mutex &fileMutex) = 0;
    virtual void updateData(ofstream &filename, mutex &fileMutex) = 0;
    virtual void deleteData( ofstream &filename, mutex &fileMutex) = 0;
...
public:
   ...
   void saveData(ofstream &file, mutex &fileMutex) {
    ...
    void retrieveData( mutex &fileMutex) override {
    ...
    void deleteData( ofstream &file, mutex &fileMutex) override {
	    int id;
